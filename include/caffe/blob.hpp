...
const int kMaxBlobAxes = 32; // 定义Blob最大维数
...
class Blob {
 public:
   ...
   */
  // 返回第index维的维度，如果index为负数，将从最后一维开始计算
  ...
  // Blob更新运算，可以简单理解为data和diff的merge过程，即data = data - diff
  void Update();
